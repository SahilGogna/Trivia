...
public interface AdminConstants {
	...
	public static final String OPTION_2 = "2. Modify question and/or answer for the (selected Trivia category)";
	
	public static final String OPTION_3 = "3. Delete question and answer for the (selected Trivia category)";
	
	public static final String OPTION_4 = "4. Exit this section with confirmation";
	...
	public static final String SET_QUESTION = "setQuestion";
	
	public static final String SET_ANSWER = "setAnswer";
	
	public static final String SET_ANS_UDERSCORE = "setAnswer_";
	
	public static final String OPTION_A = "_optionA";
	
	public static final String OPTION_B = "_optionB";
	
	public static final String OPTION_C = "_optionC";
	
	public static final String OPTION_D = "_optionD";
	
	public static final String ENTERED_QUESTION ="Your entered question is ";
	
	public static final String NEW_QUES_REQ = "Please enter new question";
	
	public static final String OPTION_A_REQUEST = "Enter option a";
	
	public static final String OPTION_B_REQUEST = "Enter option b";
	
	public static final String OPTION_C_REQUEST = "Enter option c";
